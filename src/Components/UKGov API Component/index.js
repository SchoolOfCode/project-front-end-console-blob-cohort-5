...
let covidChange = (actualRatePrev - actualRate ).toFixed(2)
  ...
  return (
    <>
     ...
     <div className={css.stats}>
                  ...
                  <Popover width="40%" placement="left-end" trigger={'hover'} bg="grey">
                  <PopoverTrigger>
                  ...
                  <PopoverContent  bg="white" border="1px solid black" padding="20px"  boxShadow="5px 5px #888888" borderRadius="15px">
                    ...
                    <PopoverBody bg={'white'} >
                      ...
                      <li><span style={{color:"#eed202"}}>Medium = 3.1 to 6 </span></li> <br/>
      ...
      <div className={css.stats}>
              ...
              <div className={css.rates} >
                  <div className={css[colorPrev]}>
                       <h4 style={{color:'white'}}>Last Month <br/> {actualRatePrev.toFixed(2)}</h4>
                   </div>
     
                  <div className={css[color]}>
                         <h4 style={{color:'white'}}>Today <br/>{actualRate.toFixed(2)}</h4>
                  </div>  
              </div>
